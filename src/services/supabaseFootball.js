...
export function normalizeMatch(row = {}) {
  ...
  return {
    ...
    pickTeam: activeAnalysis?.pick_team ?? aiFinalPick?.pickTeam ?? null,
    pick_team: activeAnalysis?.pick_team ?? aiFinalPick?.pick_team ?? null,
    pickTeamId: activeAnalysis?.pick_team_id ?? aiFinalPick?.pickTeamId ?? null,
    pick_team_id: activeAnalysis?.pick_team_id ?? aiFinalPick?.pick_team_id ?? null,
    pickSide: activeAnalysis?.pick_side ?? aiFinalPick?.pickSide ?? null,
    pick_side: activeAnalysis?.pick_side ?? aiFinalPick?.pick_side ?? null,
    pickSource: activeAnalysis?.pick_source ?? aiFinalPick?.pickSource ?? null,
    pick_source: activeAnalysis?.pick_source ?? aiFinalPick?.pick_source ?? null,
    pickMarket: activeAnalysis?.pick_market ?? aiFinalPick?.pickMarket ?? null,
    pick_market: activeAnalysis?.pick_market ?? aiFinalPick?.pick_market ?? null,
    pickSelection: activeAnalysis?.pick_selection ?? aiFinalPick?.pickSelection ?? null,
    pick_selection: activeAnalysis?.pick_selection ?? aiFinalPick?.pick_selection ?? null,
    pickPrice: activeAnalysis?.pick_price ?? aiFinalPick?.pickPrice ?? null,
    pick_price: activeAnalysis?.pick_price ?? aiFinalPick?.pick_price ?? null,
    ...
    analysisStatus: activeAnalysis?.analysis_status,
    analysis_status: activeAnalysis?.analysis_status,
    recommendationReason: activeAnalysis?.recommendation_reason,
    recommendation_reason: activeAnalysis?.recommendation_reason,
    marketDataUsed: activeAnalysis?.market_data_used,
    market_data_used: activeAnalysis?.market_data_used,
    oddsRowsUsed: activeAnalysis?.odds_rows_used,
    odds_rows_used: activeAnalysis?.odds_rows_used,
