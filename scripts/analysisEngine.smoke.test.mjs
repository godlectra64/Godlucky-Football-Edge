...
assert.ok(syncFootballDataSource.includes('No odds returned for today fixtures'), 'today odds sync should warn instead of failing when provider returns no odds')
